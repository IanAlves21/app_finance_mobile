...
class ApiService {
  ...
  static bool isTokenExpired(String token) {
    if (SecureStorageManager.useMock) return false; // Ignora expiração em ambiente de teste
    try {
      ...
      return DateTime.now().isAfter(expirationDate.subtract(const Duration(minutes: 1)));
    } catch (_) {
