...
class _AnalyticsTabState extends State<AnalyticsTab> {
  ...
  final List<String> _mockChartMonths = [
    'Jan',
    'Feb',
    'Mar',
    'Apr',
  ...
  final List<double> _mockChartExpenses = [
    1200.0,
    2100.0,
    1050.0,
    3100.0,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              'SPENDING IN ${_mockChartMonths[_activeBarIndex].toUpperCase()}',
                              style: TextStyle(
                                color: subTextColor,
                                fontSize: 11,
                                fontWeight: FontWeight.bold,
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: List.generate(_mockChartValues.length, (
                          index,
                        ) {
                          ...
                          return Expanded(
                            child: GestureDetector(
                              onTap: () =>
                                  setState(() => _activeBarIndex = index),
                              child: Column(
                                            ...
                                            colors: isActive
                                                ...
                                                : (isDark
                                                      ? [
                                                        ...
                                                        ] // Customized Slate/Midnight blue bars for dark mode
                                                      : [
                                                          const Color(
                                                            0xFFE2E8F0,
                                                          ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor: isDark
                  ...
                  : const Color(0xFFF1F5F9), // Beautiful slate tracker
