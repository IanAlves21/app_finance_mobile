      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          children: [
            ...
            _buildSettingTile(Icons.person_outline_rounded, 'Edit Profiles', 'Manage personal profiles', cardColor, textColor, subTextColor, isDark),
            _buildSettingTile(Icons.link_rounded, 'Connected Banks', '2 external bank accounts linked', cardColor, textColor, subTextColor, isDark),
            _buildSettingTile(Icons.card_giftcard_outlined, 'Cards Settings', 'Virtual cards and blockings', cardColor, textColor, subTextColor, isDark),
            const SizedBox(height: 28),
            _buildSectionHeader('Preferences', subTextColor),
            _buildToggleTile(Icons.dark_mode_outlined, 'Dark Mode', _darkMode, cardColor, textColor, isDark, (v) {
              setState(() {
                _darkMode = v;
                themeNotifier.value = v ? ThemeMode.dark : ThemeMode.light;
              });
            }),
            _buildToggleTile(Icons.notifications_none_rounded, 'Push Notifications', _pushNotifications, cardColor, textColor, isDark, (v) => setState(() => _pushNotifications = v)),
            _buildToggleTile(Icons.fingerprint_rounded, 'Biometric Sign-In', _biometricAuth, cardColor, textColor, isDark, (v) => setState(() => _biometricAuth = v)),
            const SizedBox(height: 28),
            _buildSectionHeader('Support', subTextColor),
            _buildSettingTile(Icons.help_outline_rounded, 'Help Center', 'FAQs and technical support', cardColor, textColor, subTextColor, isDark),
            _buildSettingTile(Icons.policy_outlined, 'Privacy Policy', 'Data security policies', cardColor, textColor, subTextColor, isDark),
          ],
        ),
      ),
    ),
