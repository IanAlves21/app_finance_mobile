              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _buildQuickAction(Icons.send_rounded, 'Send', const Color(0xFFDCFCE7), const Color(0xFF16A34A), textColor),
                      _buildQuickAction(Icons.arrow_downward_rounded, 'Request', const Color(0xFFFEF3C7), const Color(0xFFD97706), textColor),
                      _buildQuickAction(Icons.payment_rounded, 'Pay Bills', const Color(0xFFFEE2E2), const Color(0xFFDC2626), textColor),
                      _buildQuickAction(Icons.grid_view_rounded, 'More', const Color(0xFFEDE9FE), const Color(0xFF7C3AED), textColor),
                    ],
                  ),
