...
class AppColors {
  ...
  static const Color darkSlate = Color(0xFF0F1B35);          // Soft midnight shadow & main text color
  static const Color accentOrange = Color(0xFFF97316);       // Brand primary orange
  static const Color accentOrangeLight = Color(0xFFFB923C);  // Brand soft orange highlight
  ...
  static const Color greenGrowth = Color(0xFF4ADE80); // Pastel green for positive growth badge
