...
void main() {
  ...
  testWidgets('ProgressBarCard keeps original color when percentage is <= 80% (0.8)', (WidgetTester tester) async {
  ...
  testWidgets('ProgressBarCard turns red when percentage is > 80% (0.8)', (WidgetTester tester) async {
    const testColor = Colors.blue;
  ...
  testWidgets('ProgressBarCard turns red and changes text color when percentage is > 100% (1.0)', (WidgetTester tester) async {
    const testColor = Colors.blue;
